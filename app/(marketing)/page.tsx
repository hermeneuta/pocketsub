  ...
  return (
    <>
      <section className="mx-auto max-w-7xl">
        <h2 className="mx-auto mb-6 mt-10 max-w-2xl text-center text-5xl font-bold">
          Easiest way to manage your payments
        </h2>
        <h3 className="mx-auto text-xl max-w-3xl text-center font-medium text-zinc-700">
          Keep all your payments organized and easily accessible with
          PocketSub's simple and convenient system, designed to help you stay on
      ...
      <section className="mx-auto max-w-7xl mb-20">
        ...
        <h3 className="mx-auto max-w-2xl text-center text-zinc-700">
          Instead of relaying of manual methods such as spreadsheets or
          individual subscription accoutns, PocketSub provides a streamlined and
          user-friendly platform that enables users to easily track and manage
