        ...
        <Dialog.Portal>
          <Dialog.Overlay
            className="fixed inset-0 z-10 bg-zinc-950 
              bg-opacity-80 data-[state=open]:animate-overlayShow"
          ></Dialog.Overlay>
          <Dialog.Content
            className="fixed top-[50%] z-10 max-h-[85vh] 
            ...
            <form action="">
              ...
              <div className="relative w-1/2">
                ...
                <select
                  ...
                  value={currency}
                  onChange={(e) =>
                    setCurrency(e.target.value as SUBSCRIPTION_CURRENCY)
                  }
                  id="currency"
                >
                ...
                <div className="w-1/2">
                  ...
                  focus:ring-inset focus:ring-zinc-950"
                    ...
                    >
                      ...
                      <option value={SUBSCRIPTION_BILLING_PERIOD.QUARTERLY}>
                        Quartarly
                      </option>
                      <option value={SUBSCRIPTION_BILLING_PERIOD.YEARLY}>
                        Yearly
                      </option>
                    </select>
                    <i className="absolute inset-y-0 right-0 flex items-center pr-2 text-zinc-400 ri-arrow-down-s-line"></i>
              ...
              <div className="flex flex-col justify-center gap-4 mt-10">
                ...
                <button
                  className="flex w-full font-medium items-center 
